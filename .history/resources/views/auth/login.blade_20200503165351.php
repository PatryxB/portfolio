    ...
    <div class="content">
        <form method="POST" action="{{ route('login') }}">
            @csrf
                ...
                <button type="submit" class="btn" style="position: relative;left:0; transform:translate(0, 0);">{{ __('Login') }}</button>
                        <br><br>
                @if (Route::has('password.request'))
                    <a class="btn" style="position: relative;left:0; transform:translate(0, 0);" href="{{ route('password.request') }}">
