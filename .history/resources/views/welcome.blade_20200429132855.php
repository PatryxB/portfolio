            ...
            <section id="contact-sec">
                <div class="bg-img">
                    <form action="" method="POST" class="container">
                        ...
                        <button type="submit"class="btnS" style="float:left">Submit</button>
                        <button type="submit"class="btnS" style="margin-left:200px">Other way</button>
                        <div style="margin-top:40px">
                            <div class="block" style="margin-left:0"><i class="fab fa-facebook-f"></i></div>
                            <div class="block"><i class="fab fa-google"></i></div>
                            <div class="block"><i class="fab fa-github"></i></div>
                            <div class="block" style="margin-right:0"><i class="fab fa-facebook-messenger"></i></div>
                        </div>
                    </form>
                </div>
            </section>
